        ...
        #ifndef ADB_ADDITION_H
        #define ADB_ADDITION_H
        ...
        */
        ...
        typedef struct adb_addition adb_addition_t;
        ...
        /**
         * Constructor for creating adb_addition_t
         * @param env pointer to environment struct
         * @return newly created adb_addition_t object
         */
         ...
         * @param  _addition adb_addition_t object to free
         * @param env pointer to environment struct
        ...
        /**
         * Getter for a. 
         * @param  _addition adb_addition_t object
         * @param env pointer to environment struct
         * @return int
         */
        int AXIS2_CALL
       ...
       adb_addition_declare_parent_namespaces(
         ...
         * @param  _addition adb_addition_t object
         * @param env pointer to environment struct
         * @param addition_om_node node to serialize from
         * @param addition_om_element parent element to serialize from
        ...
        adb_addition_serialize(
            adb_addition_t* _addition,
            const axutil_env_t *env,
            axiom_node_t* addition_om_node, axiom_element_t *addition_om_element, int tag_closed, axutil_hash_t *namespaces, int *next_ns_index);
        ...
        /**
         * Check whether the adb_addition is a particle class (E.g. group, inner sequence)
        ...
        adb_addition_create_with_values(
            const axutil_env_t *env,
                ...
                /**
                 * Free adb_addition_t object and return the property value.
